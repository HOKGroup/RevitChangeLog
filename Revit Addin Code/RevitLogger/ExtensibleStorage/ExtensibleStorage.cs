    ...
    internal class ExtensibleStorage : ExternalEventInfo
    {
        ...
        public void CreateSchema()
        {
            ...
            try
            {
                ...
                IList<string> projectInfoValues = new List<string>() { "", "", "" };       // for ProjectName, ProjectNumber, ExternalProjectID respectively
                IList<string> revitLoggerValues = new List<string>() { "", "", "" };       // for scope, demoLink, ProjectNote respectively
